package org.rmt2.soap.authentication.admin.roles;
...
public class RoleQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        criteria.setRoleId(0);
        criteria.setRoleName("auth_role");
        criteria.setRoleDescription("Authenticationa Role");
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.AUTH_ROLE_GET));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.AUTH_ROLE_GET));
