...
public class ResourceTypeUpdateSoapRequestBuilderTest {
    ...
    public void testBuildRequest_New() {
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.AUTH_RESOURCE_TYPE_UPDATE));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.AUTH_RESOURCE_TYPE_UPDATE));
