...
public class UserAppRoleMaintenanceSoapRequestBuilderTest {
    ...
    public void testBuildRequest_New() {
        ...
        UserType ut = UserTypeBuilder.Builder.create()
                ...
                .addRevokedAppRole(uart3)
                .addRevokedAppRole(uart4)
                .build();
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.AUTH_USER_APPROLE_MAINT));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.AUTH_USER_APPROLE_MAINT));
