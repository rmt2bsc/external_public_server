...
public class UserGroupUpdateSoapRequestBuilderTest {
    ...
    public void testBuildRequest_New() {
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.AUTH_USER_GROUP_UPDATE));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.AUTH_USER_GROUP_UPDATE));
