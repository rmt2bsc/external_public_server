...
public class VendorUnassignItemsQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.INVENTORY_VENDOR_UNASSIGNED_ITEMS_GET));
