...
public class ItemRemovalRetailOverrideQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.INVENTORY_ITEM_RETAIL_OVERRIDE_REMOVE));
