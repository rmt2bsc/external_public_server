...
public class ItemAddRetailOverrideQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.INVENTORY_ITEM_RETAIL_OVERRIDE_ADD));
