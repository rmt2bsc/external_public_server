...
public class CurrentItemStatusHistoryQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.INVENTORY_ITEM_CURRENT_STATUS_HIST_GET));
