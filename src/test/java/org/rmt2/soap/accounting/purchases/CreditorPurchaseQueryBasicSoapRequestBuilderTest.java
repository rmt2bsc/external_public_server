package org.rmt2.soap.accounting.purchases;
...
public class CreditorPurchaseQueryBasicSoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.ACCOUNTING_CREDITPURCHASE_GET));
