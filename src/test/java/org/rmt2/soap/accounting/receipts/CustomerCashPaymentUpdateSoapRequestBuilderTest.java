...
public class CustomerCashPaymentUpdateSoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withTransaction(ApiTransactionCodes.ACCOUNTING_CASHRECEIPT_CREATE)
        ...
        xt.setXactReason("Test creating a customer cash payment transaction via message handler");
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.ACCOUNTING_CASHRECEIPT_CREATE));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.ACCOUNTING_CASHRECEIPT_CREATE));
