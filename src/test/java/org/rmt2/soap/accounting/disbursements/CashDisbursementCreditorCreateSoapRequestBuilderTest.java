...
public class CashDisbursementCreditorCreateSoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withTransaction(ApiTransactionCodes.ACCOUNTING_CASHDISBURSE_CREDITOR_CREATE)
        ...
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.ACCOUNTING_CASHDISBURSE_CREDITOR_CREATE));
