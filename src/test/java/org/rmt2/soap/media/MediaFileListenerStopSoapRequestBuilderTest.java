...
public class MediaFileListenerStopSoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withTransaction(ApiTransactionCodes.MEDIA_FILE_LISTENER_STOP)
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.MEDIA_FILE_LISTENER_STOP));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.MEDIA_FILE_LISTENER_STOP));
