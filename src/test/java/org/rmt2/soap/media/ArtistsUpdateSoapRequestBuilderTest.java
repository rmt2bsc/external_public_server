...
public class ArtistsUpdateSoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        HeaderType head =  HeaderTypeBuilder.Builder.create()
                ...
                .withTransaction(ApiTransactionCodes.MEDIA_ARTIST_UPDATE)
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.MEDIA_ARTIST_UPDATE));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.MEDIA_ARTIST_UPDATE));
    ...
    public void testBuildResponse() {
        ...
        rst.setMessage("New artist, 10, was updated successfully");
