...
public class MediaTypeQuerySoapRequestBuilderTest {
    ...
    public void testBuildRequest() {
        ...
        Assert.assertTrue(bodyXml.contains(ApiTransactionCodes.MEDIA_MEDIATYPE_GET));
        SoapMessageHelper util = new SoapMessageHelper();
        String soapXml = util.createRequest(bodyXml);
        Assert.assertNotNull(soapXml);
        Assert.assertTrue(soapXml.contains(ApiTransactionCodes.MEDIA_MEDIATYPE_GET));
